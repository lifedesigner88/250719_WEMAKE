...
CREATE TYPE "public"."salray_rage" AS ENUM('$0 - $50,000', '$50,000 - $70,000', '$70,000 - $100,000', '$100,000 - $120,000', '$120,000 - $150,000', '$150,000 - $250,000', '$250,000+');--> statement-breakpoint
...
CREATE TABLE "jobs" (
	...
	"salary_range" "salray_rage" NOT NULL,
...
CREATE TABLE "reviews" (
	...
	"created_at" timestamp DEFAULT now() NOT NULL,
	"updated_at" timestamp DEFAULT now() NOT NULL,
	CONSTRAINT "rating_check" CHECK ("reviews"."rating"
    BETWEEN 1 AND 5)
);
--> statement-breakpoint
CREATE TABLE "team" (
	...
	CONSTRAINT "product_description_check" CHECK (LENGTH
