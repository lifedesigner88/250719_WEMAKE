                                            ...
                                            <ul className="grid w-[600px] font-light gap-3 p4 grid-cols-2">
                                                {menu.items.map((item) => (
                                                    <NavigationMenuItem key={item.name}
                                                        className={cn([
                                                            item.to === "/products/promote" && "col-span-2 bg-primary/10 [&_a]:hover:bg-primary/20 [&_a]:focus:bg-primary/20",
                                                            item.to === "/jobs/submit" && "col-span-2 bg-primary/10 [&_a]:hover:bg-primary/20 [&_a]:focus:bg-primary/20",
                                                        ])}
                                                    >
